...
export default function ChooseRole({
  ...
  return (
    <section className="flex flex-col gap-4 max-h-full max-w-full px-6 pt-28 content-around justify-between">
      ...
      <figure className="flex items-end justify-center mt-12">
        {role === 'USER' ? (
          <>
            <Image
              priority
