...
export default function ConfirmModal() {
  ...
  return (
    <dialog className="fixed z-[300] top-0 left-0 w-full h-full bg-[#424242] bg-opacity-60 flex items-center justify-center">
      <div className="flex flex-col items-center justify-around w-[80%] h-[180px] py-[10px] px-[20px] bg-white bg-opacity-90 rounded-xl shadow-xl flex-shrink-0">
        <p className="text-[16px] text-center whitespace-pre-wrap">{content}</p>
